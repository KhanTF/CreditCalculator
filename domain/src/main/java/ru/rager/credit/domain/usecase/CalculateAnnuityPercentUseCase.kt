...
class CalculateAnnuityPercentUseCase @Inject constructor(private val calculateAnnuityPaymentUseCase: CalculateAnnuityPaymentUseCase) {
    ...
    fun getAnnuityCalculation(
        ...
        when {
            ...
            rate >= CreditConstants.MAX_CREDIT_RATE_EXCLUSIVE -> {
                ...
                calculateAnnuityPaymentUseCase.getAnnuityCalculation(creditDebtSum, rate, creditTerm)
            }
        }
    }
